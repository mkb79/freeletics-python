...
class ApiRequestBuilder:
    ...
    def get_calendar_by_date(self,
        ...
        return self._session.build_request('GET', url, headers=headers, params=params)
    ...
    def login_user(self, username: str, password: str) -> httpx.Request:
        ...
        headers = {
            ...
            'User-Agent': 'nutrition-ios-1083 (iPhone; iOS 14.7.1; Nutrition '
                          '1.30.1; com.freeletics.nutrition; en_GB; BST; release)'
        }
    
        data = {"authentication": {"email": username, "password": password}}
        # data = json.dumps(data, separators=(',', ':'))
        return self._session.build_request("POST", url, json=data, headers=headers)    
    
    def logout_user(self, refresh_token: str, user_id: Union[str, int]) -> httpx.Request:
    ...
    def update_id_token(self, refresh_token: str, user_id: Union[str, int]
        ...
        return self._session.build_request('POST', url, data=data)
